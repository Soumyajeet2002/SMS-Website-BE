...
exports.DemoSlotBookingController = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const demo_booking_service_1 = require("./demo_booking.service");
const update_booking_dto_1 = require("./dto/update-booking.dto");
const create_booking_dto_1 = require("./dto/create-booking.dto");
let DemoSlotBookingController = class DemoSlotBookingController {
    bookingService;
...
__decorate([
    ...
    (0, common_1.Post)('get-demo-request-details'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_booking_dto_1.GetDemoRequestDetailsDto, Object]),
    __metadata("design:returntype", void 0)
], DemoSlotBookingController.prototype, "getAll", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update demo slot booking(s)' }),
    (0, swagger_1.ApiBearerAuth)('access-token'),
    (0, common_1.Patch)('confirm-booking'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
...
], DemoSlotBookingController);
//# sourceMappingURL=demo_booking.controller.js.map