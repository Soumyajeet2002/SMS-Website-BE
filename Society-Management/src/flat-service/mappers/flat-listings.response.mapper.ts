import { mediaResponseMapper } from "src/media/mappers/media.response.mapper";

export function flatListingResponseMapper(entity: any): any {
    ...
    return {
        ...
        media: Array.isArray(entity.media)
            ? mediaResponseMapper(entity.media)
            : []
    };
}
