...
const vehicle_registration_controller_1 = require("./vehicle-registration.controller");
let VehicleModule = class VehicleModule {
};
exports.VehicleModule = VehicleModule;
exports.VehicleModule = VehicleModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([vehicle_registration_entities_1.VehicleRegistrationEntity])],
        controllers: [vehicle_registration_controller_1.VehicleController],
        providers: [vehicle_registration_service_1.VehicleService],
        exports: [vehicle_registration_service_1.VehicleService],
    })
], VehicleModule);
